...
#  Angry - Excited and Calm - Sad are not significantly different, proving the hypothesis that similar tempo music do result similarly (no significant difference between them).

# Other comparisons that differs in tempo are all significantly different, meaning that there is a main effect of tempo on reaction time.
...
# Angry - Sad are not significantly different, proving the hypothesis that negatively valenced music do result similarly (no significant difference between them).

# Calm - Excited are significantly different, although p-value is slightly higher than others, opposing the hypothesis that positively valenced music do not result less betrayal choices (significant difference between them).

# Other comparisons that differs in tempo are all significantly different, meaning that there is a main effect of tempo on choices.

# estimate positive > and negative <
```
